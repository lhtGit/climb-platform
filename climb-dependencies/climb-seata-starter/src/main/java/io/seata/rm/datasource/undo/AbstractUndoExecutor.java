...
import com.climb.common.util.ApplicationContextUtil;
import com.climb.seata.validate.DataCustomizeValidation;
...
public abstract class AbstractUndoExecutor {
    private DataCustomizeValidation dataCustomizeValidation = ApplicationContextUtil.getBean(DataCustomizeValidation.class);
    ...
    protected boolean dataValidationAndGoOn(Connection conn) throws SQLException {
        ...
        if (!afterEqualsCurrentResult.getResult()) {
            ...
            if (beforeEqualsCurrentResult.getResult()) {
                ...
                //增加 自定义验证
                if(dataCustomizeValidation.isRecordsEquals(afterRecords, currentRecords).getResult()){
                    // no need continue undo.
                    return false;
                }
                if (LOGGER.isInfoEnabled()) {
