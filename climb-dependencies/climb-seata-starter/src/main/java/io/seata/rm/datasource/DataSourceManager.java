...
public class DataSourceManager extends AbstractResourceManager implements Initialize {
    ...
    public void registerResource(Resource resource) {
        if(resource instanceof DataSourceProxyLcn){
     ...
     * @param resourceId
     */
    public boolean isLcn(String resourceId){
        Resource datasource = dataSourceCache.get(resourceId);
        return datasource instanceof DataSourceProxyLcn;
    }
